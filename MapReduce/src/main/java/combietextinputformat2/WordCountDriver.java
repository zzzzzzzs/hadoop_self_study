package combietextinputformat2;
...
public class WordCountDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //设置CombineTextInputFormat的虚拟存储大小，实际上和块大小一样。
        ...
        FileOutputFormat.setOutputPath(job,new Path("D:\\Data\\atguigu0317\\bigdata\\008_Hadoop\\HadoopSummary\\IdeaHadoopLearnSrc\\testFile\\output4"));
        //7.提交Job
